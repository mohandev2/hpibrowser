...
#ifndef __HPI_SUB_PROVIDER_DAT_H__
#define __HPI_SUB_PROVIDER_DAT_H__
 ...
 ***********************************************/
class cHpiSubProviderDAT : public cHpiSubProvider
{
public:

    explicit cHpiSubProviderDAT();
...
private:
    ...
    cHpiSubProviderDAT( const cHpiSubProviderDAT& );

    cHpiSubProviderDAT& operator =( const cHpiSubProviderDAT& );
};


#endif // __HPI_SUB_PROVIDER_DAT_H__
