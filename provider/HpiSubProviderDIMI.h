...
#ifndef __HPI_SUB_PROVIDER_DIMI_H__
#define __HPI_SUB_PROVIDER_DIMI_H__
 ...
 ***********************************************/
class cHpiSubProviderDIMI : public cHpiSubProvider
{
public:

    explicit cHpiSubProviderDIMI();
...
private:
    ...
    cHpiSubProviderDIMI( const cHpiSubProviderDIMI& );

    cHpiSubProviderDIMI& operator =( const cHpiSubProviderDIMI& );
};


#endif // __HPI_SUB_PROVIDER_DIMI_H__
