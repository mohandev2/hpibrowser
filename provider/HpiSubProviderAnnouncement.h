...
#ifndef __HPI_SUB_PROVIDER_ANNOUNCEMENT_H__
#define __HPI_SUB_PROVIDER_ANNOUNCEMENT_H__
 ...
 ***********************************************/
class cHpiSubProviderAnnouncement : public cHpiSubProvider
{
public:

    explicit cHpiSubProviderAnnouncement();

    ~cHpiSubProviderAnnouncement();
...
private:
    ...
    cHpiSubProviderAnnouncement( const cHpiSubProviderAnnouncement& );

    cHpiSubProviderAnnouncement& operator =( const cHpiSubProviderAnnouncement& );
};


#endif // __HPI_SUB_PROVIDER_ANNOUNCEMENT_H__
