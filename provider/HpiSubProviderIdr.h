...
#ifndef __HPI_SUB_PROVIDER_IDR_H__
#define __HPI_SUB_PROVIDER_IDR_H__
 ...
 ***********************************************/
class cHpiSubProviderIdr : public cHpiSubProvider
{
public:

    explicit cHpiSubProviderIdr();
...
private:
    ...
    cHpiSubProviderIdr( const cHpiSubProviderIdr& );

    cHpiSubProviderIdr& operator =( const cHpiSubProviderIdr& );
};


#endif // __HPI_SUB_PROVIDER_IDR_H__
