...
#ifndef __HPI_SUB_PROVIDER_LOG_ENTRY_H__
#define __HPI_SUB_PROVIDER_LOG_ENTRY_H__
 ...
 ***********************************************/
class cHpiSubProviderLogEntry : public cHpiSubProvider
{
public:

    explicit cHpiSubProviderLogEntry();

    ~cHpiSubProviderLogEntry();
...
private:
    ...
    cHpiSubProviderLogEntry( const cHpiSubProviderLogEntry& );

    cHpiSubProviderLogEntry& operator =( const cHpiSubProviderLogEntry& );
};


#endif // __HPI_SUB_PROVIDER_LOG_ENTRY_H__
