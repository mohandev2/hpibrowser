...
#ifndef __HPI_SUB_PROVIDER_IDR_AREA_H__
#define __HPI_SUB_PROVIDER_IDR_AREA_H__
 ...
 ***********************************************/
class cHpiSubProviderIdrArea : public cHpiSubProvider
{
public:

    explicit cHpiSubProviderIdrArea();

    ~cHpiSubProviderIdrArea();
...
private:
    ...
    cHpiSubProviderIdrArea( const cHpiSubProviderIdrArea& );

    cHpiSubProviderIdrArea& operator =( const cHpiSubProviderIdrArea& );
};


#endif // __HPI_SUB_PROVIDER_IDR_AREA_H__
