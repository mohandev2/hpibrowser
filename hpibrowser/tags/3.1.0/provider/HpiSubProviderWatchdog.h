...
#ifndef __HPI_SUB_PROVIDER_WATCHDOG_H__
#define __HPI_SUB_PROVIDER_WATCHDOG_H__
 ...
 ***********************************************/
class cHpiSubProviderWatchdog : public cHpiSubProvider
{
public:

    explicit cHpiSubProviderWatchdog();

    ~cHpiSubProviderWatchdog();
...
private:
    ...
    cHpiSubProviderWatchdog( const cHpiSubProviderWatchdog& );

    cHpiSubProviderWatchdog& operator =( const cHpiSubProviderWatchdog& );
};


#endif // __HPI_SUB_PROVIDER_WATCHDOG_H__
