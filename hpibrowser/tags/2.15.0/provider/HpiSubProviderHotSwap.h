...
#ifndef __HPI_SUB_PROVIDER_HOT_SWAP_H__
#define __HPI_SUB_PROVIDER_HOT_SWAP_H__
 ...
 ***********************************************/
class cHpiSubProviderHotSwap : public cHpiSubProvider
{
public:

    explicit cHpiSubProviderHotSwap();

    ~cHpiSubProviderHotSwap();
...
private:
    ...
    cHpiSubProviderHotSwap( const cHpiSubProviderHotSwap& );

    cHpiSubProviderHotSwap& operator =( const cHpiSubProviderHotSwap& );
};


#endif // __HPI_SUB_PROVIDER_HOT_SWAP_H__
