...
#ifndef __HPI_SUB_PROVIDER_FUMI_H__
#define __HPI_SUB_PROVIDER_FUMI_H__
 ...
 ***********************************************/
class cHpiSubProviderFUMI : public cHpiSubProvider
{
public:

    explicit cHpiSubProviderFUMI();
...
private:
    ...
    cHpiSubProviderFUMI( const cHpiSubProviderFUMI& );

    cHpiSubProviderFUMI& operator =( const cHpiSubProviderFUMI& );
};


#endif // __HPI_SUB_PROVIDER_FUMI_H__
